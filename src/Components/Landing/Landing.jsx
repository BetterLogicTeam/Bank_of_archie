    ...
    return (
      ...
      >
        <Modal.Header closeButton>
          ...
          <div className="sc-eEVmNe sc-fyjqAk ceRHWJ dtoRLS"><div className="sc-bdnxRM sc-gKAaRy sc-iCoGMd fzUdiI fHYJrX kMthTr"><div className="css-xy7yfl">Select a token</div></div></div>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body className=''>
        
        <div className="sc-bUQyIj kKJihv mt-4"></div>
        <div style={{flex: "1 1 0%"}}><div className='self'><div style={{height: "112px", width: "100%"}}><div className=" my-3 paddig sc-bdnxRM sc-gKAaRy sc-iCoGMd sc-iXeHaJ fzUdiI fHYJrX kMthTr eGJNEW token-item-ETHER ethr" disabled="" style={{position: "absolute", left: "0px", top: "0px", height: "56px", width: "100%"}}><img src={swap} className="sc-kizEQm qRAyn"/><div className="sc-EZqKI iONckA"><div title="ARC" className="css-8mokm4 dark">ARC</div><div className="sc-jJMGnK light hCiMzG css-165qfk5">ARC </div></div><span></span><div className="sc-bdnxRM sc-gKAaRy sc-jrsJWt fzUdiI fHYJrX ipgglb" style={{justifySelf: "flex-end"}}></div></div><div className="hooveer paddig sc-bdnxRM mt-4 self_emg sc-gKAaRy sc-iCoGMd sc-iXeHaJ fzUdiI fHYJrX kMthTr bDwXbT token-item-0x6dE594f9ab88B02bc890e0C4eB0B2b936E3Cf2E4" style={{position: "absolute", left: "0px", top: "56px", height: "56px", width: "100%"}}><img className="me-3 sc-cKRKFl cwJYNm" alt="WARC logo" src={swap}/><div className="sc-EZqKI iONckA"><div title="Wrapped ARC" className="css-8mokm4 dark">WARC</div><div className='d-flex light'><span className="d-flex sc-jJMGnK hCiMzG css-165qfk5">Wrapped  </span><span>ARC</span></div></div><span></span><div className="sc-bdnxRM sc-gKAaRy sc-jrsJWt fzUdiI fHYJrX ipgglb" style={{justifySelf: "flex-end"}}></div></div></div></div></div>
        </Modal.Body>
      </Modal>
    );
  }
  ...
  function MyVerticallyCenteredModal3(props) {
    return (
      ...
      >
        ...
        <div className="sc-bUQyIj kKJihv mt-4"></div>
        <div style={{flex: "1 1 0%"}}><div className='self'><div style={{height: "112px", width: "100%"}}><div className=" my-3 paddig sc-bdnxRM sc-gKAaRy sc-iCoGMd sc-iXeHaJ fzUdiI fHYJrX kMthTr eGJNEW token-item-ETHER ethr" disabled="" style={{position: "absolute", left: "0px", top: "0px", height: "56px", width: "100%"}}><img src={swap} className="sc-kizEQm qRAyn"/><div className="sc-EZqKI iONckA"><div title="ARC" className="css-8mokm4 dark">$ARCE</div><div className="d-flex light"><span className="sc-jJMGnK light hCiMzG css-165qfk5">Everest </span><span>Cash</span> </div></div><span></span><div className="sc-bdnxRM sc-gKAaRy sc-jrsJWt fzUdiI fHYJrX ipgglb" style={{justifySelf: "flex-end"}}></div></div><div className="hooveer paddig sc-bdnxRM mt-4 self_emg sc-gKAaRy sc-iCoGMd sc-iXeHaJ fzUdiI fHYJrX kMthTr bDwXbT token-item-0x6dE594f9ab88B02bc890e0C4eB0B2b936E3Cf2E4" style={{position: "absolute", left: "0px", top: "56px", height: "56px", width: "100%"}}><img className="me-3 sc-cKRKFl cwJYNm" alt="WARC logo" src={swap}/><div className="sc-EZqKI iONckA">
            <div title="Wrapped ARC" className="css-8mokm4 dark">$ARCV</div>
        <div className="d-flex light"><span className="sc-jJMGnK light hCiMzG css-165qfk5">Venus </span><span>Cash</span> </div>


        <div className="hooveer paddig sc-bdnxRM self_emg sc-gKAaRy sc-iCoGMd sc-iXeHaJ fzUdiI fHYJrX kMthTr bDwXbT token-item-0x6dE594f9ab88B02bc890e0C4eB0B2b936E3Cf2E4" style={{position: "absolute", left: "0px", top: "56px", height: "56px", width: "100%"}}><img className="me-3 sc-cKRKFl cwJYNm" alt="WARC logo" src={swap}/><div className="sc-EZqKI iONckA"><div title="Wrapped ARC" className="css-8mokm4 dark">$ARCR</div><div className='d-flex light'><span className="d-flex sc-jJMGnK hCiMzG css-165qfk5">Royal  </span><span> Archie </span><span> Cash</span></div></div><span></span><div className="sc-bdnxRM sc-gKAaRy sc-jrsJWt fzUdiI fHYJrX ipgglb" style={{justifySelf: "flex-end"}}></div></div>

        <div className="hooveer paddig sc-bdnxRM mt-6 self_emg sc-gKAaRy sc-iCoGMd sc-iXeHaJ fzUdiI fHYJrX kMthTr bDwXbT token-item-0x6dE594f9ab88B02bc890e0C4eB0B2b936E3Cf2E4" style={{position: "absolute", left: "0px", top: "56px", height: "56px", width: "100%"}}><img className="me-3 sc-cKRKFl cwJYNm" alt="WARC logo" src={swap}/><div className="sc-EZqKI iONckA"><div title="Wrapped ARC" className="css-8mokm4 dark">$ARCM</div><div className='d-flex light'><span className="d-flex sc-jJMGnK hCiMzG css-165qfk5">Meta   </span><span> Cash </span></div></div><span></span><div className="sc-bdnxRM sc-gKAaRy sc-jrsJWt fzUdiI fHYJrX ipgglb" style={{justifySelf: "flex-end"}}></div></div>
        
        </div><span></span><div className="sc-bdnxRM sc-gKAaRy sc-jrsJWt fzUdiI fHYJrX ipgglb" style={{justifySelf: "flex-end"}}></div></div></div></div></div>
        </Modal.Body>
      </Modal>
    );
  }
  ...
  return (
    <div>
      ...
      <button className="max sc-hfVBHA cyFpBV open-currency-select-button"><span className="sc-lfRxJW hoeYaZ">MAX</span></button>
            ...
            <img src={swap} className="sc-kizEQm qRAyn"/><span className="sc-kJNqyW dAolHO token-symbol-container">ARC</span><svg width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg" className="sc-hndLF eDmepi"><path d="M0.97168 1L6.20532 6L11.439 1" stroke="#AEAEAE"></path></svg>
      </Button>
   ...
   <MyVerticallyCenteredModal3
      ...
      />
            ...
            </div><div className="sc-eEVmNe kYKaHR"><div className="sc-bdnxRM sc-gKAaRy sc-pNWdM fzUdiI gtRDRy hEuxWI" style={{padding: "0px 1rem"}}></div></div><div id="swap-currency-output" className="sc-geBCVM dqgKzp">
